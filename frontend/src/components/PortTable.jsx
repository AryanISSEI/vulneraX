  ...
  return (
    <div className="space-y-6">
      ...
      <GlassCard delay={0.2} className="relative overflow-hidden p-6">
        <SectionHeader title="Network Topology" subtitle={`${ports.length} nodes active`} icon={Network} />
        
        <div className="relative h-[240px] w-full flex items-center justify-center mt-4">
          ...
          {ports.map((port, i) => {
            ...
            return (
              <div 
                ...
                style={{ width: '100px', transform: `rotate(${angle}deg)` }}
              />
            );
          })}

          {/* Central Server Node */}
          <div className="relative z-10 w-20 h-20 bg-black border border-primary/50 rounded-full flex items-center justify-center animate-pulse shadow-lg">
